...
// Extract the unique link without query parameters
$unique_link = basename(parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH));

// Strip any additional parameters
$unique_link = explode('?', $unique_link)[0];
...
if (!empty($landing)) {
    ...
    // Handle case where landing is not found
...
<head>
    ...
    <base href="https://my.mgoods.uz/l/">
    ...
    <style>
        ...
        .error-message {
            ...
            margin-bottom: 10px; /* Increased space below the error message */
...
<div class="main_wrapper">
    <header class="offer_section offer3">
        ...
        <div class="price_block">
            ...
            <div class="price_item new">
                <div class="text"></div>
                <div class="value"><span class="price_only7126"><?php echo number_format($product['salePrice'], 0, '.', ' '); ?> so'm</span></div>
            </div>
        </div>
    ...
    <section class="use_section">
        <div style="text-align: center; padding: 7px 15px 15px 15px;">
            <p style="font-weight: 500; font-size: 18px;"><?php echo htmlspecialchars($landing['description']); ?></p>
        </div>
    ...
    <section class="offer_section offer3 order">
        <form class="main-order-form order_form" id="order1" action="send.php" method="post">
            ...
            <div class="form-group">
                    ...
                    <input class="field" type="tel" id="phone" name="phone" placeholder="Telefon raqam" value=""
